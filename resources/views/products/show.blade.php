...
@endif
<a href="{{route('cart.show')}}"  style="margin-top: 40px;" class="stretched-link btn btn-warning">Voir mon panier</a>
  <div class = "row mt-4">
        <div class = "col-md-6">
            <div >
            ...
            <div class="card">
                <div class="text-center">
                    <img style="max-height: 200px;" src="{{ asset($selectedProduct->image) }}" alt="Product Image">
                </div>
                <div class="card-body">
        ...
        <div class="col-md-6">
            ...
            <a href="{{route('add-to-cart',$selectedProduct->id)}}"  style="margin-top: 40px;" class="stretched-link btn btn-info">Ajouter au panier</a>
        </div>
</div>

<h3 class = "mt-4">Nous vous recommandons .....</h5>
