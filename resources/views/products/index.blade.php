...
<html lang="fr">
  ...
  <header class="blog-header py-3">
    <div class="row flex-nowrap justify-content-between align-items-center">
      ...
      @if (Auth::user() && Auth::user()->role === 'catalog_manager')
            <a href="{{ route('prods') }}" class="btn btn-primary mb-3">Gérer le catalogue</a>
        @endif
  ...
  <div class="d-flex justify-content-between align-items-center pb-4 mb-4 font-italic border-bottom">
